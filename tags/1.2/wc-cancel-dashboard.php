   ...
   /* function column_default($item, $column_name){
				...
				?><p>
					...
					<?php
						...
						$actions['cancelled'] = array(
							...
							'url' 		=> wp_nonce_url( admin_url( 'admin-ajax.php?action=mark_order_cancelled&order_id=' . $post->ID ), 'woocommerce-mark-order-cancel-request' ),

							'name' 		=> __( 'Approve Request', 'woocommerce' ),
						...
						$actions['processing'] = array(
								...
								'name' 		=> __( 'Deny Request', 'woocommerce' ),
						...
						$actions['viewcancel'] = array(

							'url' 		=> 'javascript:void(0);',

							'name' 		=> __( 'Request Approved', 'woocommerce' ),
    ...
    function get_sortable_columns() {
        ...
        $sortable_columns = array(
            ...
            'order_total'     => array('order_total',false),     //true means it's already sorted
