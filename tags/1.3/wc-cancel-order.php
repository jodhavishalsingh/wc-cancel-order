...
*/
	...
	class WC_Cancel_Order {
		...
		public function __construct() {
			...
			add_filter( 'woocommerce_email_classes',array($this,'add_wc_cancel_request_order_woocommerce_email'));
		}

		public function wc_cancel_admin_head(){
		...
		public function create_wc_cancel_sql(){
			global $wpdb;
		...
		public function add_wc_cancel_request_order_woocommerce_email( $email_classes ) {
			...
			if(!file_exists(get_template_directory().'/woocommerce/emails/cancell-request-order.php')){
				
				if(!file_exists(get_template_directory().'/woocommerce/emails')){
					mkdir(get_template_directory().'/woocommerce/emails',0777,true);
				}

				copy(plugin_dir_path(__FILE__).'includes/emails/cancell-request-order.php',get_template_directory().'/woocommerce/emails/cancell-request-order.php');
			}

			
			if(!file_exists(get_template_directory().'/woocommerce/emails/cancell-request-rejecte-order.php')){
				copy(plugin_dir_path(__FILE__).'includes/emails/cancell-request-rejecte-order.php',get_template_directory().'/woocommerce/emails/cancell-request-rejecte-order.php');
			}

			
			if(!file_exists(get_template_directory().'/woocommerce/emails/plain/cancell-request-order.php')){
				
				if(!file_exists(get_template_directory().'/woocommerce/emails/plain')){
					mkdir(get_template_directory().'/woocommerce/emails/plain',0777,true);
				}

				copy(plugin_dir_path(__FILE__).'includes/emails/plain/cancell-request-order.php',get_template_directory().'/woocommerce/emails/plain/cancell-request-order.php');
			}

			
			if(!file_exists(get_template_directory().'/woocommerce/emails/plain/cancell-request-rejecte-order.php')){
				copy(plugin_dir_path(__FILE__).'includes/emails/plain/cancell-request-rejecte-order.php',get_template_directory().'/woocommerce/emails/plain/cancell-request-rejecte-order.php');
			}
			
			
			if(!file_exists(get_template_directory().'/woocommerce/emails/plain/cancell-request-approve-order.php')){
				
				if(!file_exists(get_template_directory().'/woocommerce/emails/plain')){
					mkdir(get_template_directory().'/woocommerce/emails/plain',0777,true);
				}

				copy(plugin_dir_path(__FILE__).'includes/emails/plain/cancell-request-approve-order.php',get_template_directory().'/woocommerce/emails/plain/cancell-request-approve-order.php');
			}

			
			if(!file_exists(get_template_directory().'/woocommerce/emails/cancell-request-approve-order.php')){
				copy(plugin_dir_path(__FILE__).'includes/emails/cancell-request-approve-order.php',get_template_directory().'/woocommerce/emails/cancell-request-approve-order.php');
			}
		...
		public function wc_cancel_request($id,$old_status,$new_status){
		...
		public function add_cancel_request($id,$status){
			global $wpdb;
		...
		public function approve_cancel_request($id,$status){
			global $wpdb;
			$get_count = $wpdb->get_var("SELECT COUNT(*) as total FROM ".$wpdb->prefix."wc_cancel_orders WHERE order_id=".$id);
		...
		public function reject_cancel_request($id,$status){
			global $wpdb;
			$get_count = $wpdb->get_var("SELECT COUNT(*) as total FROM ".$wpdb->prefix."wc_cancel_orders WHERE order_id=".$id);
		...
		public function wc_cancel_request_order_status() {
		...
		public function add_wc_cancel_request_to_order_statuses( $order_statuses ) {
		...
		public function mark_order_cancelled() {
		...
		public function add_wc_cancel_my_account_orders_status($actions,$order){
			global $wpdb;
		...
		public function wc_cancel_dashboard() {
